...
$result = mysqli_query($con, "SELECT * FROM tbl_job_master WHERE user_id = '$user_id'");
if (isset($_POST['search'])) {
    $quiry = $_POST['quiry'];
    $result = mysqli_query($con, "SELECT * FROM tbl_job_master WHERE (job_name LIKE '%$quiry%' OR job_compony LIKE '%$quiry%' OR education LIKE '%$quiry%') AND user_id = '$user_id'");
}
?>
<!doctype html>
...
<head>
    ...
    <title>Job List-Job Portal </title>
...
<body>
    ...
    <main>
        ...
        <!-- Featured_job_start -->
        <section class="featured-job-area mt-5 mb-5" id="find">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row d-flex justify-content-end mb-5" style="margin-right: 105px;">
                    <a type="button" class="btn btn-outline-primary" href="add_job.php">Add New Job</a>
                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a style="text-decoration:none; color:skyblue; margin-right: 5px; margin-bottom: 5px;" href="applied_job_user.php?job_id=<?= $row['job_id']; ?>"><i class="fa fa-user-circle" aria-hidden="true"></i></a>
                                                <a style="text-decoration:none; color:blue; margin-left: 5px;margin-right:5px; margin-bottom: 5px;" href="edit_job.php?job_id=<?= $row['job_id']; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                                <a style="text-decoration:none; color:#000; margin-right: 5px; margin-top: 5px;" href="delete_job.php?job_id=<?= $row['job_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                <a style="text-decoration:none; color:green; margin-left: 5px; margin-top: 5px;" href="view_job.php?job_id=<?= $row['job_id']; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                        $i++;
                                    ...
                                    echo "<td class='text-center' colspan='11'>No Data Is Found</td>";
                                }
