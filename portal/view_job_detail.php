...
if (isset($_GET)) {
    $job_id = $_GET['job_id'];
    $result = mysqli_query($con, "SELECT * FROM tbl_job_master WHERE job_id = '$job_id'");
} else {
    header('Location: job_list1.php');
    exit();
}
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="job_list1.php">Find a Jobs </a></li>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><b><?= $row['job_name']; ?></b></td>
                                    </tr>
                                    <tr>
                                        <th class="text-center" scope="col">Job Compony</th>
