...
if (isset($_POST['submit'])) {
    ...
    $image_tmp_name = $_FILES['comp_image']['tmp_name'];
    $image_folder = "assets/comp img/" . $image_name;
    ...
    $insert = "INSERT INTO tbl_job_master (user_id,job_name,job_compony,salary,experience,skill,education,start_date,end_date,comp_img)
		VALUES ('$user_id','$job','$compony','$salary','$experience','$skill','$education','$start_date','$end_date','$image_name')";

    if (mysqli_query($con, $insert)) {
        $_SESSION['success'] = "Job Inserted Successfully";
        header('Location: job_list1.php');
        exit();
    } else {
        $_SESSION['error'] = "Job Not Inserted Please Try Again...!!!";
        header('Location: job_list1.php');
        exit();
    }
}
                ...
                <form action="add_job.php" method="post" enctype="multipart/form-data">
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" class="form-control" name="job" id="job" placeholder="Job Name" required />
                        </div>
                        <div class="col-lg-6">
                            <label style="font-size: 22px;">Compony Name :</label>
                            <input type="text" class="form-control" name="compony" id="compony" placeholder="Compony Name" required />
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            <label style="font-size: 22px;">Salary (LPA) :</label>
                            <input type="text" class="form-control" name="salary" id="salary" pattern="[0-9]{7}" placeholder="Salary should be 7 digit only!" required />
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="date" class="form-control" name="start_date" id="start_date" placeholder="Applicant can apply from this date" required />
                        </div>
                        <div class="col-lg-6">
                            <label style="font-size: 22px;">Apply Upto Date :</label>
                            <input type="date" class="form-control" name="end_date" id="end_date" placeholder="Applicant can apply upto this date" required />
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            <input type="file" name="comp_image" id="comp_image" placeholder="Image" requiredclass="form-control form-control-lg" />
                            <label class="form-label" for="pic">Compony Logo</label>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-lg-4">
                            <button type="submit" class="btn btn-info btn-lg btn-block" style="margin-top: 40px;" name="submit" id="submit" placeholder="Submit" required>Submit</button>
                        </div>
                        <div class="col-lg-4"></div>
                    </div>
                </form>
